...
const FindPosts = (props) => {
  ...
  const [location, setLocation] = useState([
    props.coords ? props.coords.longitude : 18.598444,
    props.coords ? props.coords.latitude : 53.01379,
  ]);
  ...
  let posts = data.map((date) => {
    return (
      <div style={{ margin: "8% 0 0 0", position: "relative" }}>
        ...
        <HeaderContainer>
          <PostInfoParagraph>
            <UserLink
              to={{
                pathname: "/userpanel",
                params: { id: date.idUzytkownik },
              }}
            >
              {date.login || date.adres_mail || date.idUzytkownik}
            </UserLink>
          </PostInfoParagraph>
          <PostInfoParagraph>
        ...
        />
        {console.log(date.idUzytkownik + " " + userInfo.user.idUzytkownik)}
        {date.idUzytkownik == userInfo.user.idUzytkownik && (
          <div>
            <UserActionsContainer>
              <Button
                variant="outlined"
                  ...
                  <HeaderContainer>
                    <PostInfoParagraph>
                      <UserLink
                        to={{
                          pathname: "/userpanel",
                          params: { id: comment.idUzytkownik }
                        }}
                      >
                        {comment.login ||
                          comment.adres_mail ||
...
export default geolocated()(FindPosts);
